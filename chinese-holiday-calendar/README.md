...
```bash
pnpm install chinese-holiday-calendar
```
...
```typescript
// 方式1: 使用便捷函数
import { isWorkday, isHoliday, getDateInfo } from 'chinese-holiday-calendar';

// 方式2: 使用类实例
import { ChineseCalendar } from 'chinese-holiday-calendar';
const calendar = new ChineseCalendar();

// 方式3: 使用默认实例
import { calendar } from 'chinese-holiday-calendar';
```

### 基本日期判断

```typescript
import { isWorkday, isHoliday, isMakeupDay, getDateInfo } from 'chinese-holiday-calendar';
...
```typescript
import { getHolidaysInYear, getMakeupDaysInYear } from 'chinese-holiday-calendar';
...
```typescript
import { getYearStatistics, getMonthStatistics } from 'chinese-holiday-calendar';
...
```typescript
import { ChineseCalendar, DateType } from 'chinese-holiday-calendar';
...
```typescript
import { getWorkdaysBetween } from 'chinese-holiday-calendar';
